...
export class AppHeader extends LitElement {
    ...
    async _checkForUpdates() {
        try {
            const currentVersion = await cheetCode.getVersion();
        } catch (err) {
    ...
    getViewTitle() {
        const titles = {
            onboarding: "Welcome to Shan's CheetCode",
            main: "Shan's CheetCode",
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: "Shan's CheetCode",
        };
        return titles[this.currentView] || "Shan's CheetCode";
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${cheetCode.isMacOS ? 'Cmd' : 'Ctrl'}</span
