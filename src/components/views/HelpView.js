...
export class HelpView extends LitElement {
    ...
    async _loadKeybinds() {
        try {
            const keybinds = await cheetCode.storage.getKeybinds();
            if (keybinds) {
            ...
            <div class="unified-page">
                <div class="unified-wrap">
                    ...
                    <section class="surface">
                        ...
                        <div class="link-row">
                            <button class="link-button" @click=${() => this._open('https://github.com/shantanu')}>Website</button>
                            <button class="link-button" @click=${() => this._open('https://github.com/shantanu')}>GitHub</button>
