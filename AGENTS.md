...
This is **Shan's CheetCode**, an Electron-based real‑time AI assistant which
captures screen and audio for contextual AI responses. The code is JavaScript
and uses Electron Forge for packaging.
...
Upstream changes from the original project may occasionally be
cherry‑picked. When merging:
